...
const isNum = (input) => {
  let validateNum = /[0-9]/g;
  return validateNum.test(input);
};
...
const containsWorld = (input) => {
  let validateWorld = /world/g;
  return validateWorld.test(input);
 };
...
const isCapitalized = (str) => {
  let capped = str.match(/[A-Z][a-z]*/g);
  console.log('console',capped);
  return capped;
};
